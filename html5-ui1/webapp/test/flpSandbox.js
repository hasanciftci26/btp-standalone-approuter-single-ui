		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI 1",
									"targetURL": "#ndbstraininghtml5ui1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbstraininghtml5ui1-display": {
								"semanticObject": "ndbstraininghtml5ui1",
								"action": "display",
								"description": "UI 1",
								"title": "UI 1",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.training.html5ui1",
									"url": sap.ui.require.toUrl("ndbs/training/html5ui1")
								}
							}
						}
					}
